...
public class ReportContent {
	...
	public ReportContent(String representation, String reviewedResult, String reportWriter, String reportWriterUID,
	...
	public String toString() {
		return "ReportContent [id=" + id + ", patientUID=" + patientUID + ", studyInstanceUID=" + studyInstanceUID
